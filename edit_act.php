    ...
    if ($foto_size > 2097152) {
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "UPDATE guru SET nama_guru='$nama_lengkap', guru='$guru', alamat='$alamat', foto_guru='$foto_nama_new' WHERE id_guru='$id'");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
          $query = mysqli_query($koneksi, "UPDATE guru SET nama_guru='$nama_lengkap', guru
          ='$guru', alamat='$alamat' WHERE id_guru='$id'");
