...
if ($foto_size > 2097152) {
	...
	if ($foto_nama != "") {
		...
		if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "INSERT INTO guru VALUES ('','$nama_lengkap', '$kelas', '$alamat', '$foto_nama_new')");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
    	 $query = mysqli_query($koneksi, "INSERT INTO guru(nama_guru, guru, alamat) VALUES ('$nama_lengkap', '$kelas', '$alamat')");
